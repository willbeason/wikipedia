...
func file_pkg_documents_documents_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_pkg_documents_documents_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pkg_documents_documents_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Page); i {
			case 0:
				return &v.state
			case 1:
